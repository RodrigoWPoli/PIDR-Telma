...
MONITORED_VARIABLES = [
    ...
    ("Otr_acc",       "ns=2;s=0:TELMA!Otr_acc",       "Int16"),   # Motor torque
    ("Rfrd_acc",      "ns=2;s=0:TELMA!Rfrd_acc",       "Int16"),   # Motor speed (rpm)
    ("Ent_bob_cour",  "ns=2;s=0:TELMA!Ent_bob_cour",   "Boolean"), # Coil horizontal position
    ("Ent_bob_abou",  "ns=2;s=0:TELMA!Ent_bob_abou",   "Boolean"), # Coil changing position (vertical)
    # Useful extras
    ("TempMoteur_acc","ns=2;s=0:TELMA!TempMoteur_acc",  "Float"),   # Motor temperature
    ("Lcr_acc",       "ns=2;s=0:TELMA!Lcr_acc",         "Float"),   # Motor current
    ("FinProd",       "ns=2;s=0:TELMA!FinProd",         "Boolean"), # End of production signal
]
...
def collect(duration_seconds: int, csv_output: str = None) -> None:
    """
...
if __name__ == "__main__":
    ...
    duration = 60  # default: collect for 60 seconds
    if len(sys.argv) > 1:
